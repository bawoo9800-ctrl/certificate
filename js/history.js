...
async function loadHistory(page = 1) {
    try {
        ...
        console.log("📊 result.total (타입:", typeof result.total, ", 값:", result.total, ")");
        ...
        console.log("🔍 최종 totalCount:", totalCount, "(타입:", typeof totalCount, ")");
        ...
        //         }
        if (searchQuery) totalCount = filteredData.length;
